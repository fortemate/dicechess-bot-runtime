...
- Tool-managed pull requests (such as those generated by Jules or automated tools) may use tool-native branch names. Branch-name gates or workflow checks must not reject issue-linked tool-managed pull requests.
